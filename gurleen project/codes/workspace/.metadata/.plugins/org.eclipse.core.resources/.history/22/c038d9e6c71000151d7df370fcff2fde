...
public class MyProcessor{
	...
	ArrayList<ArrayList<HashMap>> dbList = new ArrayList();
	void displayImage(ArrayList<ArrayList<HashMap>> imageList,HashMap imgNames,JFrame f)
	{	
		FuncImage.bufferedImageShow(imageList,imgNames,f);
		/*Mat displayImg=new Mat();
		displayImg=Highgui.imread(imageName);
		String fName = imageName.split("\\\\")[imageName.split("\\\\").length-1];
		String label = imgNames.get(fName).toString();
		FuncImage.bufferedImageShow(displayImg, windowName,label);*/
	}

	public void imageProcessor(String args,JFrame f) {
		imgNames.put("image (1).jpg", "osteospermum white");
		imgNames.put("image (2).jpg", "Calendula Officinalis");
		imgNames.put("image (3).jpg", "chrysanthemum multicole");
		imgNames.put("image (4).jpg", "Dianthus caryophyllus");
		imgNames.put("image (5).jpg", "dimorphotheca");
		imgNames.put("image (6).jpg", "gazania rigens");
		imgNames.put("image (7).jpg", "Carpobrotus edulis");
		imgNames.put("image (8).jpg", "viola tricolor");
		imgNames.put("image (9).jpg", "Phlox drummondii");
		imgNames.put("image (10).jpg", "Dianthus barbatus");
		imgNames.put("image (11).jpg", "verbena rigida");
		imgNames.put("image (12).jpg", "acroclinium roseum");
		imgNames.put("image (13).jpg", "antwer hollyhock");
		imgNames.put("image (14).jpg", "aster");
		imgNames.put("image (15).jpg", "Senecio cruentus");
		imgNames.put("image (16).jpg", "Coreopsis_lanceolata");
		imgNames.put("image (17).jpg", "Cosmos bipinnatus");
		imgNames.put("image (18).jpg", "dahlia");
		imgNames.put("image (19).jpg", "helichrysum_bracteatum");
		imgNames.put("image (20).jpg", "Linum_perenne");
		imgNames.put("image (21).jpg", "matricaria_recutita");
		imgNames.put("image (22).jpg", "nasturtium");
		imgNames.put("image (23).jpg", "Helianthus annuus");
		imgNames.put("image (24).jpg", "Xerochrysum_bracteatum");

		System.loadLibrary( "opencv_java2410" );
		Mat rgbInpImage = Highgui.imread(args);
		...
		String[] flowerName={"osteospermum white","Calendula Officinalis","chrysanthemum multicole","Dianthus caryophyllus","dimorphotheca","gazania rigens","Carpobrotus edulis","viola tricolor","Phlox drummondii","Dianthus barbatus","verbena rigida"};
		int[] DB1=new int[9];
		...
		//to show db1
		ArrayList<HashMap> db1Images= new ArrayList<HashMap>();
		for(int index=0;index<DB1_cnt;++index)
		{
        	...
        	String fName = formattedString.split("\\\\")[formattedString.split("\\\\").length-1];
    		
			HashMap h = new HashMap();
			h.put("name",formattedString);
			h.put("label",fName);
        	db1Images.add(h);
		}
		dbList.add(db1Images);
		/////DB1 is ready
...
////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////
        ...
        //show DB2
        ArrayList<HashMap> db2Images= new ArrayList<HashMap>();
		for(int index=0;index<DB2_cnt;++index)
		{
			
			formattedString = String.format("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\renamedFlowerWithName\\image (%d).jpg",DB2[index]);
...
////////////////////////////////////////////////////////////////////////////
        ...
        ArrayList<HashMap> db3Images= new ArrayList<HashMap>();
		for(int index=0;index<DB3_cnt;++index)
		{
			
			formattedString = String.format("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\renamedFlowerWithName\\image (%d).jpg",DB3[index]);
			System.out.println("DB3["+index+"]="+DB3[index]);
			String fName = formattedString.split("\\\\")[formattedString.split("\\\\").length-1];
		...
		dbList.add(db3Images);
		displayImage(dbList,imgNames,f);
	}
