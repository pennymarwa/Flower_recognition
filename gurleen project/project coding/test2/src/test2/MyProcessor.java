...
public class MyProcessor{
	...
	void displayImage(String imageName,String windowName)
	{	
	...
	public void imageProcessor(String args) {
		...
		int[] DB_dominantColor={0,5,3,2,0,3,2,6,2,2,6};
		...
		int B_RANGE_LOW_DOMINANT_COLOR=143;		//MACRO	//use this to find the dominant color	
		int B_RANGE_LOW=20;						//MACRO	//use this as lower cut-off for segmentation to ensure segmentation of dark part of flower
		int B_RANGE_HIGH=262;	//MACRO
		int O_RANGE_LOW=21;		//MACRO
		int O_RANGE_HIGH=37;	//MACRO
		int V_RANGE_LOW=263;	//MACRO
		int V_RANGE_HIGH=307;	//MACRO
		...
		else if((maxPosB*2>=B_RANGE_LOW_DOMINANT_COLOR && maxPosB*2<=B_RANGE_HIGH))
		{
			dominantColor=0;
		}
