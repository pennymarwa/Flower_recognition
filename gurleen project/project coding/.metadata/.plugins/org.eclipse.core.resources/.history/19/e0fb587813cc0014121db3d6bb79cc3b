...
public class boundryExtraction {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		System.loadLibrary( "opencv_java2410" );
		//Mat rgbInpImage = Highgui.imread("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\renamed\\image (20).jpg");
		Mat rgbInpImage = Highgui.imread("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\renamedFlowerWithName\\image (11).jpg");
		...
		else if(maxPosB<ORANGE_BLUE_TH && maxPosG>ORANGE_G_R_TH && maxPosR>ORANGE_G_R_TH)
		{
			dominantColor=5;
		}
...
////////////////////////////////////////////////////////////////////////////
        ...
        {
        	formattedString = String.format("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\renamed\\image (%d).jpg",DB2[cnt]);
        	//dummyImg=Highgui.imread(formattedString);
			//String formattedOutputString = String.format("D:\\flowerRecognitionProject\\dataBase\\clientDataBase\\outputs\\DB1(%d).jpg",index);
