...
public class MyProcessor{
	...
	public void imageProcessor(String args,JFrame f) {
		...
		imgNames.put("image (13).jpg", "antwerp_hollyhock");
		imgNames.put("image (14).jpg", "aster");
		imgNames.put("image (15).jpg", "cineraria");
		imgNames.put("image (16).jpg", "Coreopsis_lanceolata");
		imgNames.put("image (17).jpg", "cosmos_flower");
		...
		imgNames.put("image (23).jpg", "sunflower");
		...
		String[] flowerName={"akila daisy white","calendula","chrysanthemum multicole","dianthus","dimorphotheca","gazania","ice plant","pansy","phlox","sweet william","verbena"};
		int[] DB1=new int[9];
